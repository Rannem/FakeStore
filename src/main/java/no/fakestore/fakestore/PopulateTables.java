...
public class PopulateTables {
    ...
    public void populate() {
        User s1 = new User("Sindre Broholm", "Sæther", Gender.MALE, "Sindreset@gmail.com", "004793071137", "1993-07-19", "sindre", "123456", "123456", "Movollen 100", "7091");
        userRepository.save(s1);
        Book b = new Book ("21.99", "Fox in Sox", "Dr.Seuss", "Random House", BookGenre.CHILDREN, "Awesome children's book.", "June 19, 1965", "English", "For all ages.", "/Assets/foxinsox.png");
        bookRepo.save(b);
        ...
        Game s = new Game("49.99", "Minecraft", "Mojang AB", "PC, Console", GameGenre.SANDBOX, "Amazing sandbox game with zombies.", "November 19, 2009", "Suitable for 7+", "/Assets/minecraft.jpg");
        gameRepo.save(s);
        ...
        Cart cart = new Cart();
        cart.setUser(s1);
        cart.getCartItems().add(new CartItem(b));
        cart.getCartItems().add(new CartItem(s));
