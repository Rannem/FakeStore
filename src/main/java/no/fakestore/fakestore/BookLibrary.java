...
public class BookLibrary {
    ...
    public BookLibrary() {
        ...
        books.add(new Book("24.00", 11003, "Black fist", "B. Obama", "White House", BookGenre.THRILLER, "From Africa to a white villa", "June 19, 2000", "English", "For all ages.", "/Assets/obama.png"));
